...
public class SwitchListener {
    ...
    public static void choose(MsgGet msgGet, Map<Class,Object> invokeParams){
        ...
        if (msgGet instanceof GroupMsg) {
            ...
            logger.debug("SwitchListener：群聊消息");
            return;
            ...
            logger.debug("SwitchListener：群聊消息撤回事件");
            return;
            ...
            logger.debug("SwitchListener：监听好友请求事件");
            return;
            ...
            logger.debug("SwitchListener：监听好友头像变动事件");
            return;
            ...
            logger.debug("SwitchListener：监听好友增加事件");
            return;
            ...
            logger.debug("SwitchListener：监听好友昵称变动事件");
            return;
            ...
            logger.debug("SwitchListener：监听好友减少事件");
            return;
            ...
            logger.debug("SwitchListener：监听群友增加事件");
            return;
            ...
            logger.debug("SwitchListener：监听群友减少事件");
            return;
            ...
            logger.debug("SwitchListener：监听群添加请求事件");
            return;
            ...
            logger.debug("SwitchListener：监听群成员权限变动事件");
            return;
            ...
            logger.debug("SwitchListener：监听群名称变动事件");
            return;
            ...
            logger.debug("SwitchListener：监听群友群名片变动事件");
            return;
            ...
            logger.debug("SwitchListener：监听群友头衔变动事件");
            return;
        }
    }
