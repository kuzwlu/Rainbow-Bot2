...
public class EmailUtil {
    ...
    public void sendActiveMail(String receiveMailAccount, String title, String content) throws Exception {
        ...
        // 3. 创建一封邮件
        MimeMessage message = createMimeMessage(session,title,content, myEmailAccount, receiveMailAccount);
    ...
    public MimeMessage createMimeMessage(Session session,String title,String content, String sendMail, String receiveMail) throws Exception {
        ...
        // 2. From: 发件人
        message.setFrom(new InternetAddress(sendMail, email_username, "UTF-8"));
